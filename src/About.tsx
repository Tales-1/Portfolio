...
const About:React.FC<Props> = () => {
    ...
    return ( 
            <motion.section 
                ...
                >
                <h1 className="my-12 text-center font-bold text-3xl lg:text-4xl text-[#8892b0]">&#60;About /&gt;</h1>
                ...
                <div className="flex flex-col-reverse w-3/4 max-w-[90rem] m-auto
                    ...
                    <div className="flex flex-col gap-12 justify-around p-8 w-full relative z-10 rounded-md text-slate-300 " >
                        ...
                        In January 2022, I took a big step in my learning journey when I took freeCodeCamp's JavaScript course. After a month of intense study, I made the leap from pure theory to practice and haven't looked back since.<br/><br/> 
                        From learning how to create a calculator using Vanilla JS, to creating a miniature role-playing game, to building a near-complete e-commerce app in React, I've demonstrated the ability to solve problems effectively, and a desire to learn more and more. I'm currently looking for a job in the technical field as a front-end developer.</p>
                    </div>
