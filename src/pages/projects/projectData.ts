...
const projectData: Data[] = [
  {
    ...
    description:
      "My most ambitious endeavour to date. A dummy e-commerce website based on a business my lovely wife would like to start. I have noticeably bought a domain name in anticipation that this business will become an actuality.  ",
    src: ecommerce,
  ...
  },
  {
    ...
    pageRoute: "rpg-game",
    description:
      "Fuelled by my love for RPGs, I created a turn-based RPG with different characters and enemy levels. I thoroughly enjoyed this project, whether it was designing the user interface or putting my object-oriented programming skills to the test.",
    src: rpg,
  ...
  },
  {
    ...
    description:
      "Back when Wordle went viral. After a month of learning Javascript I decided to make my own variant of this popular game, completely from scratch, and without referring to tutorials. This is my favourite project to date.",
    src: wordl,
  ...
  },
  {
    ...
    pageRoute: "quiz-app",
    description:
      "A challenge featured in Scrimba's React basics course. My first 'major' React project dealing with fetching data and sorting it accordingly.",
    src: quiz,
    ...
    motive:
      "This project was built in response to a challenge put forth in the React Basics course on Scrimba. It was around this time I was getting to grips with the core concepts relating React and found this extremely challenging to complete. As challenging it was, I found that my understanding of what I had learnt thus far was consolidated.",
    features: [
      "Questions fetched",
      "State management",
      "Randomseed",
      "New questions upon refresh",
    ],
    learnt: [
      "Fetch Api",
      "Passing states as props",
      "manipulating state to control UI",
  ...
  },
  {
    ...
    description:
      "1 month into learning React I decided to make a Tic-Tac-Toe game from scratch. Much like the 'Wordl Slang Game' I refused to use a tutorial and conquered this challenge in a few days.",
    src: tictactoe,
